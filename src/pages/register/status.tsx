    ...
    <div className="font-noto-sans-thai py-16 text-gray-900">
      ...
      <div className="mx-auto flex w-full max-w-lg flex-col px-6 sm:max-w-2xl">
        ...
        <p className="mt-2 text-center text-sm leading-[17px] text-gray-500">
          ...
          ถ้าผู้สมัครได้รับสถานะนี้ ผู้สมัครจะต้องแก้ไขแบบฟอร์มโดยกดที่ข้อความ แก้ไขแบบฟอร์ม ในกล่องแสดงสถานะ หากมีข้อสงสัยเพิ่มเติมสามารถสอบถามรายละเอียดเพิ่มเติมตามช่องทางติดต่อที่ระบุไว้
        </p>
      </div>
    </div>
  )
