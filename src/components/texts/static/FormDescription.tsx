  ...
  return (
    <div className="rounded-xl border border-gray-600 border-opacity-60 px-6 pt-4 pb-5">
      ...
      <ol className="list-decimal pl-6">
        ...
        <li>
          นักเรียนผู้เข้าแข่งขันต้องกำลังศึกษาอยู่ใน
          <span className="underline">
            ระดับมัธยมศึกษาตอนต้น
          </span>ของปีการศึกษา {open.getFullYear() + 543} ในสถานศึกษาเดียวกัน
          <span className="text-red-400">
            *ยกเว้นผู้เข้าแข่งขันวิชาคอมพิวเตอร์
            ต้องกำลังศึกษาอยู่ในระดับมัธยมศึกษาตอนต้นหรือระดับมัธยมศึกษาตอนปลายของปีการศึกษา{" "}
